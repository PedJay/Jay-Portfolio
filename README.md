...
- Animated hero section and particle background
- Skill section with grouped proficiency bars
...
The project illustrations are local SVG files inside:

`assets/projects/`

This keeps the portfolio fast and avoids broken external image links.
